...
class TPOT(object):
    ...
    def fit(self, features, classes, feature_names=None):
        ...
        try:
            ...
            new_col_names = {new_col_names[column]: str(column).zfill(10)
                for column in training_testing_data.columns.values if type(column) != str}
    ...
    def _polynomial_features(self, input_df):
        ...
        new_col_names = {new_col_names[column]: str(column).zfill(10)
            for column in modified_df.columns.values if type(column) != str}
